...
namespace Blue
{
        ...
        : name(name)
    {
		...
		D3D11_INPUT_ELEMENT_DESC inputDesc[] =
		{
			...
			// { "TANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 32 + 12, D3D11_INPUT_PER_VERTEX_DATA, 0 },
			{ "TANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
			// { "BITANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 32 + 12 + 12, D3D11_INPUT_PER_VERTEX_DATA, 0 }
